          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((bt) => (
              <Link
                key={bt.type}
                href={`/vehicles?${bt.type === 'ELECTRIC' ? 'fuelType' : 'bodyType'}=${bt.type}`}
                className="group flex flex-col items-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-primary-50 dark:hover:bg-gray-700 hover:shadow-md transition-all"
              >
                <bt.icon className="w-10 h-10 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 transition-colors" />
                <span className="mt-3 font-semibold text-gray-700 dark:text-gray-300 group-hover:text-primary-600">
                  {bt.name}
                </span>
                <ChevronRight className="w-4 h-4 mt-1 text-gray-400 dark:text-gray-500 group-hover:text-primary-600" />
              </Link>
            ))}
          </div>
        </div>
            ...
            {loading
              ...
              : featured.slice(0, 8).map((v) => (
                  <div
                    ...
                    className={
                      isDark
                        ? '[&_.bg-white]:!bg-gray-800 [&_.text-gray-900]:!text-white [&_.text-gray-500]:!text-gray-400 [&_.bg-gray-100]:!bg-gray-700 [&_.text-gray-600]:!text-gray-300 [&_.shadow-md]:shadow-gray-900'
                        : ''
                    }
                  >
            ...
            {loading
              ...
              : latest.map((v) => (
                  <div
                    ...
                    className={
                      isDark
                        ? '[&_.bg-white]:!bg-gray-800 [&_.text-gray-900]:!text-white [&_.text-gray-500]:!text-gray-400 [&_.bg-gray-100]:!bg-gray-700 [&_.text-gray-600]:!text-gray-300'
                        : ''
                    }
                  >
                    <VehicleCard vehicle={v} />
