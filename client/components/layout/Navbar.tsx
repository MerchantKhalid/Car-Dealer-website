...
//   return (
//     <nav className="bg-white dark:bg-gray-900 shadow-sm border-b dark:border-gray-700 sticky top-0 z-40 transition-colors duration-200">
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex justify-between h-16">
//           {/* Logo */}
//           <Link href="/" className="flex items-center gap-2">
...
//       {/* Mobile menu */}
//       {isOpen && (
//         <div className="md:hidden border-t dark:border-gray-700 bg-white dark:bg-gray-900 pb-4 transition-colors">
//           <div className="px-4 pt-2 space-y-1">
//             <Link
//               href="/"
...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 shadow-sm border-b dark:border-gray-700 sticky top-0 z-40 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2">
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="md:hidden border-t dark:border-gray-700 bg-white dark:bg-gray-900 pb-4 transition-colors duration-300">
          <div className="px-4 pt-2 space-y-1">
            <Link
              href="/"
              className="block py-2 text-gray-600 dark:text-gray-300 hover:text-primary-600"
